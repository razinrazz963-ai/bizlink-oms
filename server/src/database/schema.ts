...
export const ROLE_DEFAULT_PERMISSIONS: Record<UserRole, string[]> = {
  ...
  manager: [
    ...
    'applications.view', 'applications.create', 'applications.edit', 'applications.assign', 'applications.status',
    'documents.view', 'documents.upload', 'documents.download', 'documents.delete',
    'tasks.view', 'tasks.create', 'tasks.edit', 'tasks.delete',
    'employees.view', 'employees.create', 'employees.edit',
    'reports.view', 'services.manage', 'notifications.manage'
  ],
  employee: [
    'customers.view', 'customers.create', 'customers.edit',
    'applications.view', 'applications.create', 'applications.edit', 'applications.status',
...
export type CustomerType = 'Individual' | 'Company' | 'Business Owner' | 'Other';
...
export interface ServiceItem {
  ...
  totalFee: number; // AED (basePrice + governmentFee + serviceFee)
...
export interface PaymentRecord {
  id: string;
  receiptNumber: string; // e.g. "REC-2026-00001"
  customerId: string;
  customerName: string;
  applicationId?: string;
  applicationTrackingNumber?: string;
...
export interface ActivityLog {
  ...
  userRole: string;
  action: string;
  entityType: 'customer' | 'application' | 'document' | 'payment' | 'invoice' | 'service' | 'employee' | 'task' | 'settings' | 'auth';
  entityId?: string;
  description: string;
  timestamp: string;
}
